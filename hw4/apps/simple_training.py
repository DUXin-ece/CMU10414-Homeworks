...
def train_ptb(
    ...
    for ep in range(1, n_epochs + 1):
        avg_acc, avg_loss = epoch_general_ptb(
            data, model, seq_len, loss_func, opt, clip, device, dtype
        )
        print("Epoch: {}/{}.............".format(ep, n_epochs), end=" ")
        print("Accuracy: {:.4f}, Training Loss: {:.4f}".format(avg_acc, avg_loss))
...
def evaluate_ptb(
    ...
    print("Accuracy: {:.4f}, Evaluation Loss: {:.4f}".format(avg_acc, avg_loss))
    return avg_acc, avg_loss
    ### END YOUR SOLUTION
